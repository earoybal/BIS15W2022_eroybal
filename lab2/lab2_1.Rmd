...
This result demonstrates that there is/are missing or nonapplicable values in the data. This means that NAs, if not removed, make data analysis impossible.
