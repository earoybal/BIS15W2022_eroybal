...
```
The OR operator selects all values that meet at least one of the required conditions in filter, giving more than 16 rows of 
...
```
97 superheros have this combination of superpowers.
